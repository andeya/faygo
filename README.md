...
Faygo uses the new architecture to make itself is the most suitable Go Web framework for developping API. Just define a struct Handler, Faygo will automatically bind, verify the request parameters and generate the online API documentation. [Go to \<User Manual\>](https://github.com/henrylee2cn/faydoc)
